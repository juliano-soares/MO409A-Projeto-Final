...
public class BillBrowserManager {
	...
	public void validateBill(Bill bill,
		...
		// ensure all the times are exactly the same in case constructor generates
		// different value
	...
	/**
	 * Retrieves all the billPayments for a given patient between dateFrom and
	 * dateTo
	 * 
	 * @param dateFrom
	 * @param dateTo
	...
	/**
	 * Stores a new {@link Bill} along with all its {@link BillItems} and
	 * {@link BillPayments}
	 * 
	 * @param newBill      - the bill to store.
	 * @param billItems    - the list of bill's items
	 * @param billPayments - the list of bill's payments
	 * @return <code>true</code> if the bill has been stored, <code>false</code>
	 *         otherwise.
	 * @throws OHServiceException
	 */
	 ...
	 * @return <code>true</code> if the payments have been stored,
	 *         <code>false</code> otherwise.
	 * @throws OHServiceException
	 */
	...
	/**
	 * Updates the specified {@link Bill} along with all its {@link BillItems} and
	 * {@link BillPayments}
	 * 
	 ...
	 * @throws OHServiceException
	 * @deprecated this method should not be called for its potentially huge
	 *             resultset
	 */
	@Deprecated
	 ...
	 * 
	 * @param billPayments the {@link BillPayments} associated to the bill to
	 *                     retrieve.
